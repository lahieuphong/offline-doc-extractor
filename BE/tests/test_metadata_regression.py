"""Regression tests for metadata normalizer.

Run inside backend container:
    PYTHONPATH=/app pytest -q tests/test_metadata_regression.py
"""
...
def test_issue_date_does_not_use_legal_basis_as_promulgation_date():
    text = (
...
def test_missing_fields_are_visible_not_blank_and_not_guessed():
